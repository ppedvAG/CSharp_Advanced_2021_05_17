...
namespace WebAPI_Course
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            }) //Freischaltung der WEBAPI -> Benötigt ein Controller Verzeichnis
                .AddXmlSerializerFormatters(); //Mithilfe des XML Formatter, können wir die Ergebnis der HTTP-Methoe als XML übertragen (wenn angefordert) 
